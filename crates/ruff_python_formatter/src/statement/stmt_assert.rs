...
use crate::expression::parentheses::{
    optional_parentheses, OptionalParentheses, Parentheses, Parenthesize,
};
...
impl FormatNodeRule<StmtAssert> for FormatStmtAssert {
    fn fmt_fields(&self, item: &StmtAssert, f: &mut PyFormatter) -> FormatResult<()> {
        ...
        ) = msg.as_deref()
        {
            ...
            if parenthesize_test.needs_parentheses(f.context()) == OptionalParentheses::Multiline
                && parenthesize_message.needs_parentheses(f.context())
